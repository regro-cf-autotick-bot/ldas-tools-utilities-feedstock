About ldas-tools-utilities-feedstock
====================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ldas-tools-utilities-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ldas-tools-utilities-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ldas-tools-utilities
# for installing globally
pixi global install ldas-tools-utilities
```
...
It is possible to list all of the versions of `ldas-tools-utilities` available on your platform:
...
```
pixi search ldas-tools-utilities --channel conda-forge
```
